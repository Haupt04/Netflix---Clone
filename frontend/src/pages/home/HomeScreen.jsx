  ...
  return (
    <>
      <div className='relative h-screen text-white '>
        ...
        <img src={ORIGINAL_IMG_BASE_URL + trendingContent?.backdrop_path} alt='Hero Image' className='absolute top-0 left-0 w-full h-full object-cover -z-50'onLoad={() => setImgLoading(false)}/>
