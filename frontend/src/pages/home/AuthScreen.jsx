    ...
    <div className='hero-bg relative'>
      ...
      <div className='py-10 bg-black text-white'>
        <div className='flex max-w-6xl mx-auto items-center justify-center md:flex-row flex-col-reverse px-4 md:px-2'>
          {/* Left Side Section Two  */}
          <div className='flex-1 relative'>
            <div className='relative'>
              <img src='/stranger-things-lg.png' alt='Stranger Thing Image' className='mt-4'/>
        ...
        <div className='flex max-w-6xl mx-auto items-center justify-center flex-col-reverse md:flex-row px-4 md:px-2'>
          ...
          <div className='flex-1 text-center md:text-left'>
            ...
            <p className='text-lg md:text-xl'>
              Send kids on adventures with their favourite characters in a space made for them-free with your membership.
            </p>
          </div>
        </div>
      </div>
